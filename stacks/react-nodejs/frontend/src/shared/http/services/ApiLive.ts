...
export const ApiLive = Layer.succeed(
    ApiService,
    ApiService.of({
        ...
        patch: (path: string, expectedStatus: HttpStatus, options?: PostOptionType) =>
            pipe(
                Effect.tryPromise({
                    try: () =>
                        fetch(getApiUrl(path), {
        ...
        delete: (path: string, expectedStatus: HttpStatus, options?: PostOptionType) =>
            pipe(
                Effect.tryPromise({
                    try: () =>
                        fetch(getApiUrl(path), {
