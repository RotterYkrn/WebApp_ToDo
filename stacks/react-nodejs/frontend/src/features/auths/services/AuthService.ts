...
export interface IAuthService {
    ...
    readonly signUpApi: (input: SignUpInput) => Effect.Effect<void, SharedError, ApiService>;
    readonly signInApi: (input: SignInInput) => Effect.Effect<void, SharedError, ApiService>;
